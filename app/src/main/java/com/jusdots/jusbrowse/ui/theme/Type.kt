...
enum class AppFont(val displayName: String, val fontFamily: FontFamily) {
    ...
    DM_SERIF("DM Serif Text", FontFamily(
        Font(R.font.dm_serif_text_regular, FontWeight.Normal),
        Font(R.font.dm_serif_text_italic, FontWeight.Normal, FontStyle.Italic)
    )),
    GOOGLE_SANS("Google Sans Code", FontFamily(
        Font(R.font.google_sans_code_regular, FontWeight.Normal)
    )),
    JETBRAINS_MONO("JetBrains Mono", FontFamily(
        Font(R.font.jetbrains_mono_regular, FontWeight.Normal)
    )),
    LIBRE_BARCODE("Libre Barcode", FontFamily(
        Font(R.font.libre_barcode_regular, FontWeight.Normal)
    ))
}
...
// Default Typography for preview/initialization
